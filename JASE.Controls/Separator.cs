...
namespace JASE.Controls
{
    public partial class Separator : Control
    {
        ...
        [Browsable(true), DisplayName("DisabledColor"), Category("Appearance"), Description("Gets or sets the Disabled Color for this Line.")]
        public Color DisabledColor { get; set; } = Color.DimGray;
        ...
        private DrawTypes DrawType { get; set; }
